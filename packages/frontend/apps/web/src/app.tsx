...
// FlowState — BetterAuth session + data bridge providers
import { FlowStateProviders } from '@affine/core/modules/flowstate/providers';
        ...
        <CacheProvider value={cache}>
          <I18nProvider>
            <AffineContext store={getCurrentStore()}>
              {/* FlowState: BetterAuth session + API data bridge */}
              <FlowStateProviders>
                <RouterProvider
